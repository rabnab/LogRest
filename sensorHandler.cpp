...
void SensorHandler::outputPressTempSensors() {
  ...
  tempUtil::print(" --- T2: ");
  tempUtil::print(htu21df.readTemperature());
  tempUtil::print("(");
  tempUtil::print(tAvg);
  tempUtil::print("=");
  tempUtil::print(tempUtil::celsiusTomilliKelvin(tAvg));
  tempUtil::print("mK) ---  Humi: ");
  tempUtil::print(htu21df.readHumidity());
  tempUtil::print("%(");
  tempUtil::print(hAvg);
  tempUtil::println(")");
}
...
void SensorHandler::printAccumulatedTempInfo() {
  tempUtil::print("T: ");
  tempUtil::print(getActualTemperatureAvg());
  tempUtil::print(" +- ");
  tempUtil::print(getActualTemperatureStdev());

  tempUtil::print(" H: ");
  tempUtil::print(getActualHumidityAvg());
  tempUtil::print(" +- ");
  tempUtil::println(getActualHumidityStdev());
